 ...
 *
 * @param {Object} val The value to test
 * @return {boolean} True if value is a Date, otherwise false
 */
function isDate(val) {
 ...
 *
 * @param {Object} val The value to test
 * @return {boolean} True if value is a File, otherwise false
 */
function isFile(val) {
 ...
 *
 * @param {Object} val The value to test
 * @return {boolean} True if value is a Blob, otherwise false
 */
function isBlob(val) {
